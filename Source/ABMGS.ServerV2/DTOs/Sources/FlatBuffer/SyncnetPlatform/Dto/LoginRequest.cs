...
public struct LoginRequest : IFlatbufferObject
{
  ...
  public static Offset<SyncnetPlatform.Dto.LoginRequest> CreateLoginRequest(FlatBufferBuilder builder,
  ...
  public static Offset<SyncnetPlatform.Dto.LoginRequest> EndLoginRequest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SyncnetPlatform.Dto.LoginRequest>(o);
  }
}
